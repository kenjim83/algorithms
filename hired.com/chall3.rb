...
# generate a new array that is sorted in strictly ascending order by increasing or decreasing
# each of the elements of the initial array with integer values in the [0, X] range.

# Example:
# Having the initial array [5, 4, 3, 2, 8] the minimum value for X is 3.
# Decrease the first element (5) by 3, decrease the second one (4) by 1, increase
# the third one (3) by 1, increase the forth one (2) by 3 and do nothing to the last one (8).
...
# strictly ascending order means that each element is greater than the preceding one
